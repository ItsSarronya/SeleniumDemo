...
public class GenerateReport_Extent {
	...
	public void startReport() {
		...
		extent.addSystemInfo("Host Name", "Automation Learner").addSystemInfo("Environment", "Automation Testing")
				.addSystemInfo("User Name", "Sarronya");
